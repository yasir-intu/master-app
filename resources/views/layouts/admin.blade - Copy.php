...
<link href="{{asset('contents/admin')}}/assets/css/skins/aside/navy.css" rel="stylesheet" type="text/css" />        <!--end::Layout Skins -->
...
<script>
  ...
  gtag('config', 'UA-37564768-1');
    ...
    <!-- begin::Body -->
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed {{Request::is('admin')? '':'kt-subheader--fixed'}} kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading"  >
...
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
	<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">		
		...
		<ul class="kt-menu__nav ">
            ...
            @endif
			@if (Auth::user()->role_id<=4)
			<li class="kt-menu__item {{Request::is('admin/client-message')? 'kt-menu__item--here' : ''}} {{Request::is('admin/client-message/next-pagination/{after}')? 'kt-menu__item--here' : ''}} {{Request::is('admin/client-message/next-pagination/{before}')? 'kt-menu__item--here' : ''}}" aria-haspopup="true"><a href="@if (Auth::user()->role_id<=2){{route('facebook-page-message')}}@endif @if (Auth::user()->role_id==3){{route('facebook-page-message-senior-executive')}}@endif @if (Auth::user()->role_id==4){{route('facebook-page-message-employee')}}@endif" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-facebook-letter-logo"></i><span class="kt-menu__link-text">Client Messages</span></a></li>
			@endif
			@if (Auth::user()->role_id==4)
        ...
        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px">
            <span class="kt-header__topbar-icon">
                @php
                    $unread=0;
                @endphp
				@if(Request::is('admin/client-message'))
                @foreach ($a as $all)    
...
<!-- end:: Header -->
				...
				<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="padding: 10px;" id="kt_content">
					...
					<!-- begin:: Footer -->
<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" style="z-index: -1;">
...
<!-- end:: Quick Panel --> */
	...
	<!--begin::angular -->
	<script src="{{asset('contents/admin')}}/assets/js/angular.min.js" type="text/javascript"></script>
	<script src="{{asset('contents/admin')}}/assets/js/ajax.js" type="text/javascript"></script>
