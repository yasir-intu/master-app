...
@section('login')
                        ...
                        <div>
                            <h4 style="margin-bottom: .5rem;">Create an account</h4>
                            <p class="mb-2">Setup a new account in a minute.</p>
                        </div>
                        <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <img src="{{ asset('masterdesign/public/contents/login') }}/img/name.png" class="img-fluid" alt="">
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ old('user_name') }}" required autocomplete="user_name" autofocus placeholder="User Name">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" type="email" placeholder="Email Address">
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary btn-block" formmethod="POST" formaction="{{ route('register') }}">Register</button>
                            </div>
                            ...
                            <div class="mt-5 mb-4 text-center">
                                ...
                                <div class="row">
                                        <a href="{{ url('/auth/redirect/facebook') }}" class="col-sm-6 col-xs-12 mt-3">
                                    <div >
                                       ...
                                       <a href="#" class="col-sm-6 col-xs-12 mt-3">
                                    <div >
                                        <button type="button" class="btn btn-social btn-block btn-facebook">
                                            Google
                                        </button>
