...
@section('login')
                        ...
                        <div>
                            ...
                            <p class="mb-5">Use your credentials to access your account.</p>
                        </div>
                        <form>
                            @csrf
                            ...
                            <div class="row my-3">
                                <div class="col-6 d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="remember" {{ old('remember') ? 'checked' : '' }} id="cb1">
                            ...
                            <div>
                                <button type="submit" formmethod="POST" formaction="{{ route('login') }}" class="btn btn-primary btn-block">Login</button>
                            </div>

                            <div class="mt-5 mb-4 text-center">
                                <div class="d-block text-center text-sm">
                                    Or login with
                                </div>
