						...
						<div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="kt_apps_user_list_datatable" style="">
							<table class="kt-datatable__table" style="display: block; overflow-x: auto;">
                                ...
                                <tbody class="kt-datatable__body" style="">
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px; margin-left: 0px">
                                            ...
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->director->photo)}}">
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" href="#">
                                                            {{$data->director->name}}
                                                            </a>
                                                        <span class="kt-user-card-v2__desc">{{$data->director->user->roleName->role}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data->director->user->user_name}}</span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data->director->user->email}}</span>
                                        </td>
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px; margin-left: {{$x}}px">
                                        <td class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="id">
                                            <span style="width: 20px;">
                                                <label class="kt-checkbox kt-checkbox--single kt-checkbox--solid">
                                                    <input type="checkbox" value="1">&nbsp;<span></span>
                                        ...
                                        <td data-field="first_name" class="kt-datatable__cell">
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                                        <img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->executive->photo)}}">
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" href="#">
                                                            {{$data->executive->name}}
                                                            </a>
                                                        <span class="kt-user-card-v2__desc">{{$data->executive->user->roleName->role}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data->executive->user->user_name}}</span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data->executive->user->email}}</span>
                                        </td>
                                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell text-center">
                                            <span style="overflow: visible; position: relative; width: 80px;">
                                                <div class="dropdown">
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px; margin-left: {{$y}}px">
                                        <td class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="id">
                                            <span style="width: 20px;">
                                                <label class="kt-checkbox kt-checkbox--single kt-checkbox--solid">
                                                    <input type="checkbox" value="1">&nbsp;<span></span>
