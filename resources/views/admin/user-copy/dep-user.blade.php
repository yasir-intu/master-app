						...
						<div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="kt_apps_user_list_datatable" style="">
							<table class="kt-datatable__table" style="display: block; overflow-x: auto;">
                                ...
                                <tbody class="kt-datatable__body" style="">
                                    @foreach ($all as $data)
                                    <tr data-row="0" class="kt-datatable__row" style="left: 20px;">
                                    ...
                                    @if ($data->dDepartment!=null)
                                    @foreach ($data->dDepartment as $data2)
                                            ...
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data2->photo)}}">
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" href="#">
                                                            {{$data2->name}}
                                                            </a>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data2->user->roleName->role}}</span>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data2->department->department}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data2->user->user_name}}</span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data2->user->email}}</span>
                                        </td>
                                    ...
                                    @if ($data->exDepartment!=null)
                                    @foreach ($data->exDepartment as $data3)
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 20px;">
                                        ...
                                        <td data-field="first_name" class="kt-datatable__cell">
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data3->photo)}}">
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" href="#">
                                                            {{$data3->name}}
                                                            </a>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data3->user->roleName->role}}</span>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data3->department->department}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data3->user->user_name}}</span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data3->user->email}}</span>
                                        </td>
                                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell text-center">
                                            <span style="overflow: visible; position: relative; width: 80px;">
                                                <div class="dropdown">
                                    ...
                                    @if ($data->em_type!=null)
                                    @foreach ($data->em_type as $data1)
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 20px;">
                                        ...
                                        <td data-field="first_name" class="kt-datatable__cell">
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data1->photo)}}">
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" href="#">
                                                            {{$data1->name}}
                                                            </a>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data1->user->roleName->role}}</span>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data1->department->department}}</span>
                                                        <span class="kt-user-card-v2__desc d-block">{{$data1->em_type->employment}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data1->user->user_name}}</span>
                                        </td>
                                        <td data-field="email" class="kt-datatable__cell">
                                            <span style="width: 182px;">{{$data1->user->email}}</span>
                                        </td>
                                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell text-center">
                                            <span style="overflow: visible; position: relative; width: 80px;">
                                                <div class="dropdown">
