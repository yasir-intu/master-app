                                            ...
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                                        @if ($data->role_id==1)
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->superAdmin->photo)}}">
                                						@endif
                                                        @if ($data->role_id==2)
                                						...
                                						@endif
                                                        @if ($data->role_id==4)
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->employee->photo)}}">
                                						@endif
                                                        @if ($data->role_id==5)
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->author->photo)}}">
                                						@endif
                                                        @if ($data->role_id==6)
                                						<img alt="user" src="{{asset('masterdesign/public/uploads/users/'.$data->editor->photo)}}">
                                						@endif
                                                    </div>
                                                    <div class="kt-user-card-v2__details">
                                                        ...
                                                        <span class="kt-user-card-v2__desc">{{$data->roleName->role}}</span>
                                                    </div>
                                                </div>
                                            </span>
                                        </td>
