					...
					<div class="kt-form__section kt-form__section--first">
						...
						<div class="form-group">
							...
							<select name="role" class="form-control" id="role" required>
								...
								@if(Auth::user()->role_id==1 ||Auth::user()->role_id<$roles->role_id)
						...
						<div class="md" style="display: none">
							<div class="form-group">
								...
								<select name="department" class="form-control dep" id="department" required>
						...
						<div class="se" style="display: none">
							<div class="form-group">
								...
								<select name="director" class="form-control director" id="director" required>
									<option>Select Managing Director</option>
									@foreach ($md as $mds)									
									<option data-dep="{{$mds->dep_id}}" value="{{$mds->id}}">{{$mds->name}}</option>
									@endforeach
								</select>
						...
						<div class="e" style="display: none">
							<div class="form-group">
								...
								<select name="executive" class="form-control executive" id="executive" required>
									<option>Select Senior Executive</option>
									@foreach ($se as $ses)									
									<option data-dep="{{$ses->dep_id}}" data-md="{{$ses->md_id}}" value="{{$ses->id}}">{{$ses->name}}</option>
									@endforeach
								</select>
							...
							<div class="form-group">
								...
								<select name="employment" class="form-control" id="employment" required>
