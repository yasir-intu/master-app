    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                {{Request::is('admin/managing-director/all/seniour-executive')? 'Your Senior Executives' : ''}}                         
                                {{Request::is('admin/managing-director/all/employee')? 'Your Employees' : ''}}                         
                </h3>
						...
						<div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="kt_apps_user_list_datatable" style="">
							<table class="kt-datatable__table" style="display: block; overflow-x: auto;">
                                ...
                                <tbody class="kt-datatable__body" style="">
                                    ...
                                    @foreach ($em as $ems)
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                        <td class="kt-datatable__cell pl-5">
                                            {{$ems->employment}}
                                        </td>
                                    </tr>
                                    ...
                                    @if ($ses->id == $data->se_id)
                                    @if ($ems->id == $data->em_id)
