                                            ...
                                            <span style="width: 200px;">
                                                <div class="kt-user-card-v2">
                                                    <div class="kt-user-card-v2__pic">
                                                        @if ($data->role_id==1)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->superAdmin->photo)}}">
                                						@endif
                                                        @if ($data->role_id==2)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->director->photo)}}">
                                						@endif
                                                        @if ($data->role_id==3)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->executive->photo)}}">
                                						@endif
                                                        @if ($data->role_id==4)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->employee->photo)}}">
                                						@endif
                                                        @if ($data->role_id==5)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->author->photo)}}">
                                						@endif
                                                        @if ($data->role_id==6)
                                						<img alt="user" src="{{asset('uploads/users/'.$data->editor->photo)}}">
                                						@endif
                                                    </div>
