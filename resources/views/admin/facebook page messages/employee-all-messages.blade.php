    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                @if(Request::is('admin/employee/client-message'))
                                            Client Messages                 
                                @endif
                                @if(Request::is('admin/employee/client-message/progressive'))
                                    Work in Progress
                                @endif
                                @if(Request::is('admin/employee/client-message/complete'))
                                    Work Completed
                                @endif
                </h3>
        ...
        <div class="kt-subheader__toolbar">
			...
			@endif
            @if(Request::is('admin/employee/client-message'))
            <button type="submit" formaction="{{route('facebook-page-message-employee-assain-progressive')}}" formmethod="POST" class="btn btn-brand btn-md btn-tall btn-wide btn-bold btn-upper">
			Progressive
		</button>
		@endif
		@if(Request::is('admin/employee/client-message') || Request::is('admin/employee/client-message/progressive'))
        <button type="submit" formaction="{{route('facebook-page-message-employee-assain-complete')}}" formmethod="POST" class="btn btn-brand btn-md btn-tall btn-wide btn-bold btn-upper">
			Complete
		</button>
		@endif
		@if(Request::is('admin/employee/client-message/complete'))
            <button type="submit" formaction="{{route('facebook-page-message-employee-assain-reprogressive')}}" formmethod="POST" class="btn btn-brand btn-md btn-tall btn-wide btn-bold btn-upper">
			Reprogressive
		</button>
		@endif
        </div>
							...
							<table class="kt-datatable__table" style="display: block; overflow-x: auto;">
                                <thead class="kt-datatable__head">
                                    <tr class="kt-datatable__row" style="left: 0px;">
										...
										<th data-field="first_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                            <span style="width: 130px;">Progressive</span>
                                        </th>
										<th data-field="first_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                            <span style="width: 130px;">Uncomplete</span>
                                        </th>
										<th data-field="first_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                            <span style="width: 130px;">Complete</span>
                                        </th>
										<th data-field="first_name" class="kt-datatable__cell kt-datatable__cell--sort">
                                            ...
                                            <span style="width: 170px;">
                                                <div class="kt-user-card-v2">
                                                    ...
                                                    <div class="kt-user-card-v2__details">
                                                        <a class="kt-user-card-v2__name" style="font-family: 'SolaimanLipi', sans-serif;" href="{{route('message-view-employee', [$all["id"], $all["unread_count"]])}}">
