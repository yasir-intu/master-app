...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main"><i class="flaticon2-shelter"></i>
				<h3 class="kt-subheader__title d-inline-block pl-3">Dashboard</h3>
        </div>
	...
	<div class="kt-portlet__body kt-portlet__body--fluid">
		<div class="kt-widget-19">
			<div class="kt-widget-19__title">
				...
				<img class="kt-widget-19__bg"  src="{{asset('contents/admin')}}/assets/media/misc/iconbox_bg.png" alt="bg"/>
			</div>
	...
	<div class="kt-portlet__body kt-portlet__body--fluid">
		<div class="kt-widget-21">
			<div class="kt-widget-21__title">
				...
				<img src="{{asset('contents/admin')}}/assets/media/misc/iconbox_bg.png" class="kt-widget-21__bg" alt="bg"/>
			</div>
	...
	<div class="kt-portlet__body kt-portlet__body--fluid">
		<div class="kt-widget-20">
			<div class="kt-widget-20__title">
				...
				<img class="kt-widget-20__bg" src="{{asset('contents/admin')}}/assets/media/misc/iconbox_bg.png" alt="bg"/>
			</div>
    ...
    <div class="kt-portlet__body">
        <div class="kt-widget-1">
            <ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#kt_tabs_19_15e1ac279722d6" role="tab">
                        <span class="nav-link-icon"><i class="flaticon2-graphic"></i></span>
                        <span class="nav-link-title">Settings</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#kt_tabs_19_25e1ac279722d6" role="tab">
                        <span class="nav-link-icon"><i class="flaticon2-position"></i></span>
                        <span class="nav-link-title">Code</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35e1ac279722d6" role="tab">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="kt_tabs_19_15e1ac279722d6" role="tabpanel">
                ...
                <div class="tab-pane fade" id="kt_tabs_19_25e1ac279722d6" role="tabpanel">
                    <div class="kt-widget-1__item">
                        <div class="kt-widget-1__item-info">
                            <a href="#" class="kt-widget-1__item-title">UI/UX Design</a>
                            <div class="kt-widget-1__item-desc">Evrything you ever imagine</div>
                ...
                <div class="tab-pane fade" id="kt_tabs_19_35e1ac279722d6" role="tabpanel">
                    <div class="kt-widget-1__item">
                        <div class="kt-widget-1__item-info">
                            <a href="#" class="kt-widget-1__item-title">eCommerce Websites</a>
                            <div class="kt-widget-1__item-desc">Shops, Fasion wep sites & atc</div>
			...
			<div class="carousel-inner">
					...
					<div class="kt-widget-14__body">
						<div class="kt-widget-14__product">
							<div class="kt-widget-14__thumb">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/blog/1.jpg" class="kt-widget-14__image--landscape" alt="" title="" /></a>
							</div>
				...
				<div class="carousel-item">
					<div class="kt-widget-14__body">
						<div class="kt-widget-14__product">
							<div class="kt-widget-14__thumb">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/blog/2.jpg" class="kt-widget-14__image--landscape" alt="" title="" /></a>
							</div>
							<div class="kt-widget-14__content">
				...
				<div class="carousel-item">
					<div class="kt-widget-14__body">
						<div class="kt-widget-14__product">
							<div class="kt-widget-14__thumb">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/blog/4.jpg" class="kt-widget-14__image--landscape" alt="" title="" /></a>
							</div>
							<div class="kt-widget-14__content">
			...
			<div class="carousel-inner">
					...
					<div class="kt-widget-15__body">
						<div class="kt-widget-15__author">
							<div class="kt-widget-15__photo">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/users/100_14.jpg" alt="" title="" /></a>
							</div>
				...
				<div class="carousel-item">
					<div class="kt-widget-15__body">
						<div class="kt-widget-15__author">
							<div class="kt-widget-15__photo">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/users/100_3.jpg" alt="" title="" /></a>
							</div>
							<div class="kt-widget-15__detail">
				...
				<div class="carousel-item">
					<div class="kt-widget-15__body">
						<div class="kt-widget-15__author">
							<div class="kt-widget-15__photo">
								<a href="#"><img src="{{asset('contents/admin')}}/assets/media/users/100_7.jpg" alt="" title="" /></a>
							</div>
							<div class="kt-widget-15__detail">
	...
	<div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--fluid">
		<div class="kt-widget-7">
			<div class="kt-widget-7__items">
				<div class="kt-widget-7__item">
					<div class="kt-widget-7__item-pic">
						<img src="https://keenthemes.com/keen/themes/keen/theme/demo1/dist/assets/media/files/doc.svg" alt="" />
					</div>
				...
				<div class="kt-widget-7__item">
					<div class="kt-widget-7__item-pic">
						<img src="https://keenthemes.com/keen/themes/keen/theme/demo1/dist/assets/media/files/pdf.svg" alt="" />
					</div>
					<div class="kt-widget-7__item-info">
						<a href="#" class="kt-widget-7__item-title">
							S.E.R Agreement
				...
				<div class="kt-widget-7__item">
					<div class="kt-widget-7__item-pic">
						<img src="https://keenthemes.com/keen/themes/keen/theme/demo1/dist/assets/media/files/jpg.svg" alt="" />
					</div>
					<div class="kt-widget-7__item-info">
						<a href="#" class="kt-widget-7__item-title">
							FlyMore Screenshot
				...
				<div class="kt-widget-7__item">
					<div class="kt-widget-7__item-pic">
						<img src="https://keenthemes.com/keen/themes/keen/theme/demo1/dist/assets/media/files/zip.svg" alt="" />
					</div>
					<div class="kt-widget-7__item-info">
						<a href="#" class="kt-widget-7__item-title">
							ST.11 Dacuments
				...
				<div class="kt-widget-7__item">
					<div class="kt-widget-7__item-pic">
						<img src="https://keenthemes.com/keen/themes/keen/theme/demo1/dist/assets/media/files/xml.svg" alt="" />
					</div>
					<div class="kt-widget-7__item-info">
						<a href="#" class="kt-widget-7__item-title">
			...
			<div class="kt-widget-7__foot">
				<img src="{{asset('contents/admin')}}/assets/media/misc/clouds.png" alt="" />
